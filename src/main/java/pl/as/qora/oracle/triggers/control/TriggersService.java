package pl.as.qora.oracle.triggers.control;
...
public class TriggersService {
    ...
    public Collection<Objects> userTriggers(String user) {
        return objectsService.userObjects(user, ObjectTypes.TRIGGER);
    }
